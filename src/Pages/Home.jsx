        ...
        <div>
            ...
            <div className='bg-[#fffcf4] p-6 flex justify-around max950:flex-col-reverse max950:items-center'>
                ...
                <div className='flex flex-col justify-between items-center'>
                    <div>
                        <p className='text-[1.6vw] tracking-[14px] text-center font-[600] max950:text-[2vw] mt-2'>NEW ARRIVAL</p>
                        <p className='text-[12vw] tracking-[2px] font-bold stroke mt-[-2rem] max950:text-[20vw] max950:tracking-[8px]'>SALE</p>
                        <p className='text-[4.5vw] font-bold mt-[-1rem] max950:text-[8vw]'>HEADPHONE</p>
                ...
                <img className='w-[40%] max-w-[100%] max950:w-[50%]' src={headset3} alt="" />
            </div>
            <NewArrivals />
